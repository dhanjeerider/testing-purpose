# 🚀 Cloudflare Pages Deployment Guide - Vega Movies

> Complete guide to deploy Vega Movies to Cloudflare Pages with optimal performance and reliability
...
1. **Project name**: Enter your project name (e.g., `vega-movies`)
...
**Solution**: All dynamic routes in this application already have `export const runtime = 'edge';` configured at the top of the file.
...
[⬆ back to top](#-cloudflare-pages-deployment-guide---vega-movies)
