...
<header class="header">
    <div class="header-container">
        ...
        <nav class="nav-menu" id="navMenu">
            <ul class="nav-list">
                <li class="nav-item"><a href="<?php echo esc_url( home_url( '/category/adult/' ) ); ?>" class="nav-link">🔞 Adult++</a></li>
                <li class="nav-item has-submenu">
                    <a href="#" class="nav-link">OTT <svg class="dropdown-icon" viewBox="0 0 24 24"><path d="M6 9L12 15L18 9" stroke="currentColor" stroke-width="2"></path></svg></a>
                    <ul class="submenu">
                ...
                <li class="nav-item has-submenu">
                    <a href="#" class="nav-link">Movies <svg class="dropdown-icon" viewBox="0 0 24 24"><path d="M6 9L12 15L18 9" stroke="currentColor" stroke-width="2"></path></svg></a>
                    <ul class="submenu">
                ...
                <li class="nav-item"><a href="<?php echo esc_url( home_url( '/category/web/' ) ); ?>" class="nav-link">Web‑Series</a></li>
                <li class="nav-item has-submenu">
                    <a href="#" class="nav-link">Genre <svg class="dropdown-icon" viewBox="0 0 24 24"><path d="M6 9L12 15L18 9" stroke="currentColor" stroke-width="2"></path></svg></a>
                    <ul class="submenu">
                        <li><a href="<?php echo esc_url( home_url( '/category/dual-audio/' ) ); ?>">Dual Audio</a></li>
                ...
                <li class="nav-item"><a href="<?php echo esc_url( home_url( '/category/anime/' ) ); ?>" class="nav-link">Anime</a></li>
                <li class="nav-item"><a href="<?php echo esc_url( home_url( '/category/2160p-4k/' ) ); ?>" class="nav-link">4K</a></li>
                <li class="nav-item"><a href="<?php echo esc_url( home_url( '/category/k-drama/' ) ); ?>" class="nav-link">K‑Drama</a></li>
            </ul>
        </nav>
