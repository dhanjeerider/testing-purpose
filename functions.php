...
function ajax_news_theme_scripts() {
    ...
    // Theme Style
    wp_enqueue_style('ajax-news-theme-style', get_stylesheet_uri(), array('bootstrap'), '1.0.1');
    
    // Custom CSS
    wp_enqueue_style('ajax-news-custom', get_template_directory_uri() . '/assets/css/custom.css', array(), '1.0.1');
